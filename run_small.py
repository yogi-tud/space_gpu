...
def run_exp1(device="exp1",sel_increment=4):
        ...
        for f in range(1, 100, sel_increment):
            ...
            for i in range(0, 3, 1):
                    ...
                    if dataset == 2:
                        ...
                        run_sel(sel, dataset, datatype, 1, device)
...
def run_exp4(device="exp4",sel_increment=4):
...
if __name__ == '__main__':
    ...
    run_exp1(sel_increment=8)
    print("done")
    print("running experiment 2.....")
    run_exp2(sel_increment=8)
    print("done")
    print("running experiment 3.....")
    run_exp3()
    print("done")
    print("running experiment 4.....")
    run_exp4(sel_increment=8)
    print("done")